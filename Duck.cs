...
namespace Simulador_Patos_POO
{
    public class Duck
    {
        ...
        //Tentativa de ativar temporizador nas ações do patos
        /*public virtual Form2()
        {
        ...
        private Patolino pato;
        public FormPatolino(Patolino pato)
        {
        ...
        {
            string resultado = pato.usarRoupa();
        ...
        {
            string resultado = pato.vaiProShopping();
            ToolTip tooltip = new ToolTip();
            tooltip.Show(resultado, this, PointToClient(Cursor.Position), 2000);
